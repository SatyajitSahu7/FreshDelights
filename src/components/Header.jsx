    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      <div className="hidden md:flex w-full h-full justify-between">
        ...
        <img src={Logo} className="w-14 h-10 object-cover shadow-lg" alt="logo" />
          <p className="text-headingColor text-xl font-bold">Fresh<span className="text-orange-600">
          Delights
          </span></p>
        </Link>
        <div className="flex justify-center gap-9">
          <ul className="flex items-center gap-8  ml-auto">
            ...
            <Link to={"/menu"}><li className="text-base text-textColor hover:text-slate-900 hover:scale-105 duration-100 transition-all ease-in-out cursor-pointer">
              Menu
            </li></Link>
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "freshdelights2024@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
